...
CPD_BOCD_QUANDL_OUTPUT_FOLDER = lambda lbw: os.path.join(
    "data", f"quandl_cpd_bocd_{(lbw if lbw else 'none')}lbw"
)

CPD_BOCD_QUANDL_OUTPUT_FOLDER_DEFAULT = CPD_BOCD_QUANDL_OUTPUT_FOLDER(CPD_DEFAULT_LBW)

FEATURES_BOCD_QUANDL_FILE_PATH = lambda lbw: os.path.join(
    "data", f"quandl_cpd_bocd_{(lbw if lbw else 'none')}lbw.csv"
)

CPD_NEWMA_QUANDL_OUTPUT_FOLDER = lambda lbw: os.path.join(
    "data", f"quandl_cpd_newma_{(lbw if lbw else 'none')}lbw"
)

CPD_NEWMA_QUANDL_OUTPUT_FOLDER_DEFAULT = CPD_NEWMA_QUANDL_OUTPUT_FOLDER(CPD_DEFAULT_LBW)

FEATURES_NEWMA_QUANDL_FILE_PATH = lambda lbw: os.path.join(
    "data", f"quandl_cpd_newma_{(lbw if lbw else 'none')}lbw.csv"
)
