...
from settings.default import (
    QUANDL_TICKERS,
    CPD_BOCD_QUANDL_OUTPUT_FOLDER,
    FEATURES_BOCD_QUANDL_FILE_PATH,
)
from mom_trans.data_prep import (
    deep_momentum_strategy_features,
    include_changepoint_features_bocd,
)
...
def main(
    ...
    if lookback_window_length:
        features_w_cpd = include_changepoint_features_bocd(
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        return (
            QUANDL_TICKERS,
            CPD_BOCD_QUANDL_OUTPUT_FOLDER(args.lookback_window_length),
            args.lookback_window_length,
            FEATURES_BOCD_QUANDL_FILE_PATH(args.lookback_window_length),
            args.extra_lbw,
        )
